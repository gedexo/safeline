...
$(function() {
    ...
    wind.on("scroll",function () {
        ...
        if(bodyScroll > 100){
            ...
            logo.attr('src', 'static/web/img/safelinelogo.svg');
        }else{
    ...
    $('.services2 .owl-carousel').owlCarousel({
        ...
        ,freeMode: true
		, autoplay: true
        , autoplayTimeout: 1500 // Change to 1000 milliseconds (1 second)
        ,smartSpeed: 1000
...
$(".accordion").on("click", ".item", function () {
    ...
    var swiperOptions = {
        ...
        breakpoints: {
            // When window width is <= 768px (mobile), show only 1 preview slide
            768: {
                slidesPerView: 1,
            },
        },
      ...
      var pauseDuration = 500; // Adjust this value (in milliseconds) to set the pause duration after a click.
    ...
    // Function to restart autoplay after a pause
    function restartAutoplay() {
        swiper.autoplay.start();
    }

    // Add event listener to handle slider click
    swiper.on('click', function () {
        pauseAutoplay(); // Pause autoplay on click
        setTimeout(restartAutoplay, pauseDuration); // Restart autoplay after a pause
    });